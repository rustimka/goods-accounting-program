                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <select required class="form-control" name="timezone" id="timezone">
                            <option value="Europe/Moscow">UTC/GMT +03:00 - Europe/Chisinau</option>
                            <?php timezonelist() ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <span id="helpBlock2elements_on_page" class="help-block">Сколько строк будет отображаться на главном экране с приходами и продажей (рекомендуется 25)</span>
                    </div>
                </div>
            </div>
        </div>
